...
public class AesPrefs {
     ...
     * or {@link SharedPreferences.OnSharedPreferenceChangeListener}.
     *
     ...
     * @return the no log
     */
    public static String getResNoLog(@StringRes int stringId, @Nullable String defaultValue) {
     ...
     */
    public static int getIntResNoLog(@StringRes int stringId, int defaultValue) {
     ...
     */
    public static long getLongResNoLog(@StringRes int stringId, long defaultValue) {
     ...
     */
    public static double getDoubleResNoLog(@StringRes int stringId, double defaultValue) {
     ...
     */
    public static float getFloatResNoLog(@StringRes int stringId, float defaultValue) {
     ...
     */
    public static boolean getBooleanResNoLog(@StringRes int stringId, boolean defaultValue) {
